...
import { OpdhealthCheckupService } from 'src/app/_service/reception/reception_bill/opdhealth-checkup.service';
import { OpdhealthcheckupRefundService } from 'src/app/_service/reception/reception_bill_refund/opdhealthcheckup-refund.service';
...
import { MasterCategoryService } from 'src/app/_service/static/master-category.service';
...
export class OpdhealthCheckupRefundComponent implements OnInit {
  ...
  getUhidBillNoName():void{
    this.getService.getUhidBillNoName().subscribe(
      data => {
  ...
  getDetailBy_BillNo(): void {
    if (this.form.billNo != null && this.form.billNo.length >= 0 && this.form.billNo != "") {
      var newBillNo = this.form.billNo
